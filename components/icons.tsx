...
export const InstagramIcon: React.FC<IconSvgProps> = ({
  ...
  <svg fill="none" height={size || height} shapeRendering="geometricPrecision" stroke="currentColor"
    strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24"
    width={size || width} >
    <rect x="2" y="2" width="20" height="20" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37z" /><path d="M17.5 6.5h.01" />
  </svg>
);
...
export const StudentIcon: React.FC<IconSvgProps> = ({
  ...
  <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 256" height={size || height} width={size || width} >
