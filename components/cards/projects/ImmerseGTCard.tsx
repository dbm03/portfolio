...
const ImmerseGTCard = () => {
  ...
  return (
    ...
    >
      ...
      />
      <CardFooter className="absolute bottom-0 z-10 flex flex-col border-default-600 border-t-1 bg-black/40 dark:border-default-100">
